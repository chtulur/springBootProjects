package com.servermanagerfromscratch;
...
import com.servermanagerfromscratch.enumeration.Status;
import com.servermanagerfromscratch.model.Server;
import com.servermanagerfromscratch.repo.ServerRepo;

@SpringBootApplication
public class ServermanagerfromscratchApplication {

	public static void main(String[] args) {
		SpringApplication.run(ServermanagerfromscratchApplication.class, args);
	}
